		...
		<div class="col-sm-12">
			<section class="panel">
				...
				<div class="panel-body">
					<form class="form-horizontal" role="form" id="frm-rencana" action="#" method="POST">
						<input type="hidden" id="apa" name="apa" value="tambah-rencana">
...
$(document).ready(function(){
	...
	function reloading(){
		$.ajax({
			...
			method: "POST",
			cache: false,
			data: {"mod" : "<?php echo e_url('modules/view/perencanaan/rencana-program.php'); ?>"},
	...
	$('#btn-simpan-data').click(function(ev){
		ev.preventDefault();
		var post_data = "aksi=" + "<?php echo e_url('modules/controller/perencanaan/rencana-program.php'); ?>" + "&" +$('#frm-rencana').serialize();
